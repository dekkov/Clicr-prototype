...
export default function NewBusinessPage() {
    ...
    const finish = async (opts?: { saveBanConfig?: boolean; saveScanConfig?: boolean }) => {
        ...
        try {
            ...
            console.error('[new-business] finish error:', e);
            ...
            {step === 'BUSINESS' && (
                <form onSubmit={handleCreateBusiness} className="space-y-6 bg-slate-900/50 border border-slate-800 p-8 rounded-2xl shadow-xl">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button type="submit" disabled={isLoading} className="flex-1 py-4 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2">
            ...
            {step === 'AREAS' && (
                <div className="space-y-6 bg-slate-900/50 border border-slate-800 p-8 rounded-2xl shadow-xl">
                                    ...
                                    {editingAreaId !== a.id ? (
                                        ...
                                        <div className="flex items-center gap-2 w-full">
                                            <input autoFocus type="text" value={editingAreaName}
                                                ...
                                                onKeyDown={e => { if (e.key === 'Enter') handleSaveAreaName(a.id); if (e.key === 'Escape') setEditingAreaId(null); }}
                    ...
                    <div className="flex gap-3 pt-2 border-t border-slate-800">
                        ...
                        <button type="button" onClick={() => { if (createdAreas.length === 0) return; setStep('CLICRS'); }} disabled={createdAreas.length === 0}
