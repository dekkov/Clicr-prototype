  ...
  return (
    <div className="glass-panel rounded-2xl overflow-hidden border border-white/5">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
        ...
        <h2 className="text-lg font-bold text-white tracking-widest">{monthLabel}</h2>
      ...
      <div className="grid grid-cols-7 border-b border-white/5">
        {DOW.map(d => (
          <div
            key={d}
            className="py-3 text-center text-[10px] font-bold tracking-widest text-slate-500"
          >
            {d}
          </div>
        ))}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected && 'bg-violet-900/40 border-violet-500/50 hover:bg-violet-900/50'
              )}
